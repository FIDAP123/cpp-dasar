...
{
    std::cout << "Luas segitiga = " << luas_segitiga() << std::endl;//kita bisa mengeksekusi perintah ini tanpa memberikan argumennya karena kita sudah menuliskan defaultnya diatasnya, jika kita menuliskan argumennya maka defaulrnya akan tergantikan karena default akan mengisi ketika kita tidak menulis argumen dari fungsinya
    std::cout  << "Volume prisma segitiga = " << volume_prisma_segitiga(2) << std::endl;
