/*
    ...
    3.  int main () sendiri merupakan function singkatan dari int main(int argc, char** argv) atau int main(int argc, 
        char const *argv[]) tujuan dibuat singkat agar programer tidak harus menuliskan banyak, da sebenarnya lebih bagus tidak menulis singkatanya agar mengerti alurnya, dan yang namanya function tidak boleh kosong jadi kita tidak menyingkatnya justru lebih benar
