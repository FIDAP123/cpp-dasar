...
int main(int argc, char const *argv[])
{
    ...
    for (int &nilaiRef : loop_arr )
    {
        ...
        std::cout << "alamat memori nilai : " << &nilaiRef << " = " << nilaiRef << std::endl;//disini karena kita menggunakan referencing maka variable nilaiRef hanya berupa penunjuk ke memori dari array loop_arr sehingga kita bisa memanipulasi nilai array dalam loop_arr dengan merubah variable nilaiRef nya
    }
    ...
    for (int &nilaiRef2 : loop_arr )
    {
        ...
        std::cout << "alamat memori nilai : " << &nilaiRef2 << " = " << nilaiRef2 << std::endl;//disini karena kita menggunakan referencing maka variable nilaiRef hanya berupa penunjuk ke memori dari array loop_arr sehingga kita bisa memanipulasi nilai array dalam loop_arr dengan merubah variable nilaiRef nya
    }
    return 0;
}